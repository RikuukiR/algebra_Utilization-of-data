...
\begin{theorembox}[thm:相対度数]{\textbf{相対度数}}
    ...
    \[
    \textbf{(相対度数)} = \; \dfrac{\textbf{(その階級の度数)}}{\textbf{(度数の合計)}} \;
    \]
...
\begin{proof}\mbox{}\\
    \begin{table}[H]
        ...
        \hline
        135{\scriptsize 以上} & 140{\scriptsize 未満} & 2 & \answertable{0.04} & \answertable{2} & \answertable{0.04} \\
        \hline
        140 & 145 & 4 & \answertable{0.08} & \answertable{6} & \answertable{0.12} \\
        \hline
        145 & 150 & 5 & \answertable{0.10} & \answertable{11} & \answertable{0.22} \\
        \hline
        150 & 155 & 8 & \answertable{0.16} & \answertable{19} & \answertable{0.38} \\
        \hline
        155 & 160 & 11 & \answertable{0.22} & \answertable{30} & \answertable{0.60} \\
        \hline
        160 & 165 & 9 & \answertable{0.18} & \answertable{39} & \answertable{0.78} \\
        \hline
        165 & 170 & 7 & \answertable{0.14} & \answertable{46} & \answertable{0.92} \\
        \hline
        170 & 175 & 4 & \answertable{0.08} & \answertable{50} & \answertable{1.00} \\
        \hline
